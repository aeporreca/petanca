...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1en3 = RealNumber('1e-3'); _sage_const_3 = Integer(3)# Petanca: Una bibliotèca SageMath per far de calculs dins lo semianèl
...
class Permutations(CombinatorialFreeModule):
    ...
    def solve_linear(P):
        ...
        try:
            ...
            return None
        sol = vector(milp.get_values(x, convert=ZZ, tolerance=_sage_const_1en3 ))
...
_R = PP['X, Y']; (X, Y,) = _R._first_ngens(2)
P = C[_sage_const_2 ]*X + C[_sage_const_3 ]*Y - C[_sage_const_2 ]
